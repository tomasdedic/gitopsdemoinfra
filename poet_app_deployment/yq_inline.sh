...
yq write -i argo_repo/poet_app_deployment/deployment.yaml 'spec.template.spec.containers.[0].image' $(yq read argo_repo/poet_app_deployment/image_tags/image_tags.yaml image)
